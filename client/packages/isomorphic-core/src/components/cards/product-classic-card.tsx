...
import { useCart } from '../../../../../apps/admin/src/store/quick-cart/cart.context';
    ...
    <div className={cn('pb-0.5', className)}>
      <div className="relative">
        ...
        {discount ? (
          <Text
            as="span"
            className="absolute start-5 top-5 rounded-lg bg-gray-50 px-2.5 py-1.5 text-xs font-semibold dark:bg-gray-200 dark:text-gray-700"
          >
            {discount}% Discount
          </Text>
        ) : null}
