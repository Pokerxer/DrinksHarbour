        ...
        <div className="p-3 @xl:p-4 @2xl:p-5 xl:col-span-7">
          <div className="grid grid-cols-8">
            ...
            <div className="relative col-span-1 mt-1.5">
              <span className="relative mb-1.5 block h-3 w-3 rounded-full bg-gray-900 before:absolute before:-left-1.5 before:-top-1.5 before:-z-10 before:h-6 before:w-6 before:rounded-full before:bg-gray-50 dark:bg-gray-900 dark:before:bg-gray-50"></span>
          ...
          {flight.routes?.layover?.map((layover, index) => (
            ...
            >
              ...
              <div className="relative col-span-1 mt-1.5">
                <Text
                  as="span"
                  className="relative z-10 mb-1.5 block h-3 w-3 rounded-full before:absolute before:-left-1.5 before:-top-1.5 before:-z-10 before:h-6 before:w-6 before:rounded-full before:bg-gray-50 dark:bg-gray-900 dark:before:bg-gray-50"
                >
