      ...
      <div className="px-4 py-3 border-b border-muted space-y-6">
        ...
        <div className="flex items-center justify-between">
          <ActionIcon
            ...
            color="danger"
            rounded="full"
            className="hover:bg-red-500-100 dark:hover:bg-red-500-50/10 dark:hover:text-red-600"
          >
...
function CommentForm() {
  ...
  return (
    <form
      ...
      className="flex items-end gap-2 p-6 bg-gray-50 dark:bg-gray-100 border-t border-muted sticky bottom-0 inset-x-0"
    >
      <Input
        className="grow"
        name="comment"
