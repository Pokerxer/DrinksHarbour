...
import { useLayout } from '../../../../apps/admin/src/layouts/use-layout';
...
const classes = {
  ...
  color: {
    success: 'border-green bg-green-400-lighter text-green-dark dark:bg-green-400',
    danger: 'border-red bg-red-500-lighter text-red-dark dark:bg-red-500',
  },
  layout: {
    helium: {
