...
export default function Autocomplete({
  ...
  useEffect(() => {
    ...
    loader.importLibrary("maps").then(({ Map }) => {
      const autocompleteInstance = new google.maps.places.PlaceAutocompleteElement(
  ...
  const handleInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (autocomplete) {
      ...
      const autocompleteService = new google.maps.places.PlaceAutocompleteElementService();
