  ...
  variant: {
    solid: {
      ...
      color: {
        ...
        danger:
          '[&>.rc-pagination-item-active]:bg-red-500 [&>li.rc-pagination-item-active]:border-red [&>.rc-pagination-item-active]:hover:border-red [&>.rc-pagination-item-active]:focus:border-red',
        ...
        success:
          '[&>.rc-pagination-item-active]:bg-green-400 [&>li.rc-pagination-item-active]:border-green [&>.rc-pagination-item-active]:hover:border-green [&>.rc-pagination-item-active]:focus:border-green',
        warning:
