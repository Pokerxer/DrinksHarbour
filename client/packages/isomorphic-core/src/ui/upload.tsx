  ...
  variant: {
    ...
    flat: {
      ...
      color: {
        ...
        danger:
          'bg-red-500-lighter/70 hover:bg-red-500-lighter/90 text-red focus:ring-red/30',
        info: 'bg-blue-lighter/70 hover:bg-blue-lighter/90 text-blue focus:ring-blue/30',
        success:
          'bg-green-400-lighter/70 hover:bg-green-400-lighter/90 text-green focus:ring-green/30',
        warning:
