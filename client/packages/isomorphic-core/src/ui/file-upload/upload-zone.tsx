          ...
          {uploadedItems.map((file: any, index: number) => (
            ...
            >
              <figure className="group relative h-40 rounded-md bg-gray-50">
                ...
                >
                  <PiCheckBold className="text-gray-50" />
                </button>
              </figure>
              <MediaCaption
                name={file.name}
              ...
              <figure className="group relative h-40 rounded-md bg-gray-50">
                ...
                {isUploading ? (
                  ...
                  <button
                    ...
                    className="absolute right-0 top-0 rounded-full bg-gray-700/70 p-1.5 opacity-20 transition duration-300 hover:bg-red-500-dark group-hover:opacity-100"
                  >
                    <PiTrashBold className="text-gray-50" />
                  </button>
                )}
              </figure>
              <MediaCaption
