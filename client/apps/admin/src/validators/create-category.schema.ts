...
export const categoryFormSchema = z.object({
  ...
  // Classification
  type: z.enum(validTypes, { errorMap: () => ({ message: 'Please select a valid type' }) }),
  ...
  // Display
  defaultSort: z.enum(['relevance', 'price_asc', 'price_desc', 'popularity', 'newest', 'name']).optional().default('relevance'),
