            ...
            >
              ...
              {hasFilters && (
                <button
                  type="button"
                  onClick={clearFilters}
                  className="mt-5 rounded-xl border border-muted px-4 py-2 text-sm font-medium text-gray-700 hover:border-primary"
                >
                  Clear filters
                </button>
              )}
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {orders.map((order, i) => {
                    ...
                    const src =
                      SOURCE_CONFIG[order.source ?? 'web'] ?? SOURCE_CONFIG.web;
                    const open = () =>
                    ...
                    const vendors = Array.from(vendorMap.values()).filter(
                      (v) => v.payout > 0
                    );
              ...
              <div className="flex items-center gap-2">
                ...
                {(() => {
                  ...
                  const start = Math.max(
                    1,
                    Math.min(pagination.pages - span + 1, page - 2)
                  );
