...
export const productTypes = [
  ...
  {
    value: 'cocktail_ready_to_drink',
    label: 'Ready-to-Drink Cocktail',
    category: 'Alcoholic',
  },
...
export const certificationOptions = [
  ...
  {
    value: 'protected_designation',
    label: 'Protected Designation of Origin (PDO)',
  },
  {
    value: 'protected_geographical',
    label: 'Protected Geographical Indication (PGI)',
  },
  {
    value: 'traditional_specialty',
    label: 'Traditional Specialty Guaranteed (TSG)',
  },
];
