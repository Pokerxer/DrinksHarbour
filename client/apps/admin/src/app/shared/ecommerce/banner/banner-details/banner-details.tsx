...
/**
 * Banner details — read-only view of a saved banner with live placement
 * preview, analytics, schedule/targeting sidebar and admin actions.
 */
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
          ...
          <div className="space-y-5 lg:col-span-2">
            <DetailsCard banner={banner} placementLabel={placementLabel} />
            <CtaCard
              banner={banner}
              ctaCls={ctaCls}
              ctaStyleLabel={ctaStyleLabel}
            />
            <StylingCard banner={banner} />
            {banner.mobileImage?.url && <MobileImageCard banner={banner} />}
            {(banner.description || banner.subtitle) && (
              <ContentCard banner={banner} />
            )}
            {banner.notes && (
  ...
  return (
    ...
    >
      <dl>
        <InfoRow
          label="Type"
          badge={<span className="capitalize">{banner.type}</span>}
        />
        <InfoRow
          label="Placement"
  ...
  return (
    ...
    >
      <dl>
        ...
        />
        <InfoRow
          label="Whole Banner Clickable"
          badge={
            banner.ctaLink ? (
              banner.imageClickable !== false ? (
                <span className="text-emerald-600">Yes</span>
              ) : (
      ...
      {banner.ctaLink && (
        <div className="mt-3 flex items-center gap-2 rounded-lg bg-gray-50 px-3 py-2">
          ...
          <a
            href={platformLink(banner.ctaLink)}
            target="_blank"
...
function StylingCard({ banner }: { banner: any }) {
  return (
    <Card
      icon={
        <CardIcon>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <span
              ...
              style={{ backgroundColor: banner.backgroundColor || '#fff' }}
            />
      ...
      <div className="mt-4 flex items-center gap-4 border-t border-gray-100 pt-4">
        <div>
          ...
          <p className="text-sm font-medium capitalize text-gray-900">
            {String(banner.contentPosition || 'center').replace(/-/g, ' ')}
          </p>
        </div>
...
function MobileImageCard({ banner }: { banner: any }) {
  return (
    <Card
      icon={
        <CardIcon>
...
function ContentCard({ banner }: { banner: any }) {
  return (
    <Card
      icon={
        <CardIcon>
...
function ScheduleCard({ banner }: { banner: any }) {
  return (
    <Card
      icon={
        <CardIcon>
...
function DeviceTargetingCard({ banner }: { banner: any }) {
  return (
    <Card
      icon={
        <CardIcon>
...
function TagsCard({ banner }: { banner: any }) {
  return (
    <Card
      icon={
        <CardIcon>
...
function TimestampsCard({ banner }: { banner: any }) {
  return (
    <Card
      icon={
        <CardIcon>
