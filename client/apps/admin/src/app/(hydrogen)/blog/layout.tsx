...
import { PiArticleDuotone, PiPlusCircleDuotone } from 'react-icons/pi';
    ...
    <div className="-mx-4 -mt-2 flex flex-col md:-mx-5 lg:-mx-6 3xl:-mx-8">
      <div className="px-4 md:px-5 lg:px-6 3xl:px-8">
        <ModuleNavHeader
          brand="Blog"
          tabs={[
            { label: 'Posts', href: '/blog', icon: <PiArticleDuotone /> },
            { label: 'New Post', href: '/blog/create', icon: <PiPlusCircleDuotone /> },
          ]}
        />
      </div>
