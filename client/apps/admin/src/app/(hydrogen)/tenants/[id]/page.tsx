              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  },
                  {
                    label: 'Pack Markup %',
                    value:
                      t.packMarkupPercentage != null
                        ? `${t.packMarkupPercentage}%`
                        : null,
                  },
                  {
                ...
                <div className="space-y-0">
                  <InfoRow
                    ...
                    value={
                      ...
                      >
                        {(
                          t.purchaseSettings.defaultBillControlPolicy ||
                          'received'
                        ).replace(/_/g, ' ')}
                      </Badge>
                    }
            ...
            {(t.businessType ||
              ...
              <Section title="Business & Compliance">
                ...
                <InfoRow
                  ...
                  value={
                    t.idType &&
                    `${t.idType}${t.idNumber ? ` — ${t.idNumber}` : ''}`
                  }
                />
                <InfoRow
                  label="NAFDAC"
                  value={
                    t.nafdacRequired
                      ? t.nafdacNumber || 'Required — not supplied'
                      : t.nafdacNumber || null
                  }
                />
                <InfoRow
                ...
                <InfoRow
                  ...
                  value={
                    <Badge
                      color={t.kycVerified ? 'success' : 'warning'}
                      variant="flat"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-1">
                    ...
                    {t.admin.status && (
                      <Badge
                        color={
                          t.admin.status === 'active' ? 'success' : 'warning'
                        }
                        variant="flat"
                        className="text-xs capitalize"
                      >
                ...
                <div className="mt-4 space-y-2 rounded-lg border border-gray-100 bg-gray-50 p-3">
                  {[
                    { label: 'Paystack Customer', value: t.paystackCustomerId },
                    {
                      ...
                      value: t.paystackSubscriptionCode,
                    },
