              ...
              <div className="slider-item h-full w-full relative bg-[#B0A092]">
                ...
                <div className="container w-full h-full flex items-center relative">
                  ...
                  <div className="text-content basis-1/2">
                    {" "}
                    <div className="text-sub-display text-gray-50">
                      Sale! Up To 50% Off!
                    </div>{" "}
                    <div className="text-display text-gray-50 md:mt-4 mt-2">
                      Fashion for Every Occasio
                    </div>{" "}
                    <Link
                      href="/shop/breadcrumb-img"
                      className="button-main bg-gray-50 text-gray-900 md:mt-8 mt-3"
                    >
                      Shop Now
                    </Link>{" "}
                  </div>{" "}
