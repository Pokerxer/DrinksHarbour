                ...
                <div className="list-featrue lg:mt-10 mt-6">
                  ...
                  <div className="item flex lg:gap-10 gap-6">
                    ...
                    <div className="w-1/2">
                      ...
                      <div className="text-title text-gray-900 whitespace-nowrap">
                        08:00 - 20:00
                      </div>{" "}
                    ...
                    <div className="w-1/2">
                      ...
                      <div className="flex items-center sm:gap-4 gap-2 mt-2">
                        ...
                        <Link
                          ...
                          target="_blank"
                          className="item bg-gray-50 w-10 h-10 rounded-full flex items-center justify-center hover:bg-black-900 hover:text-gray-50 duration-300"
                        >
                          {" "}
