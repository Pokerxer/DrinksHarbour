...
export const invoiceFormSchema = z.object({
  ...
  invoiceNumber: z.string({ required_error: "This field is required" }),
  createDate: z.date({ required_error: messages.createDateIsRequired }),
  dueDate: z.date({ required_error: messages.dueDateIsRequired }),
  status: z.string({ required_error: messages.statusIsRequired }),
  shipping: z.coerce
    .number()
