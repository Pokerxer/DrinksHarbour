...
import { fileSchema } from "@/utils/validators/common-rules"; // step 2
export const propertyTypeSchema = z.object({
  propertyType: z.string().min(1, messages.propertyTypeIsRequired),
}); // generate form types from zod validation schema
export type PropertyTypeSchema = z.infer<typeof propertyTypeSchema>; // step 3
export const placeTypeSchema = z.object({
  placeType: z.string().min(1, messages.placeTypeIsRequired),
});
export type PlaceTypeSchema = z.infer<typeof placeTypeSchema>; // step 4
export const locationSchema = z.object({
  address: z.string().optional(),
  lat: z.number().optional(),
  lng: z.number().optional(),
});
export type LocationSchema = z.infer<typeof locationSchema>; // step 5
...
export type FormStep5Schema = z.infer<typeof formStep5Schema>; // step 6
...
export type FormStep6Schema = z.infer<typeof formStep6Schema>; // step 7
