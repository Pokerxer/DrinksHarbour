          ...
          <div className="top-nav-main flex justify-between max-md:justify-center h-full">
            ...
            <div className="right-content flex items-center gap-5 max-md:hidden">
              ...
              <Link href={'https://www.facebook.com/'} target="_blank">
                <i className="icon-facebook text-gray-900"></i>
              </Link>
              <Link href={'https://www.instagram.com/'} target="_blank">
                <i className="icon-instagram text-gray-900"></i>
              </Link>
              <Link href={'https://www.youtube.com/'} target="_blank">
                <i className="icon-youtube text-gray-900"></i>
              </Link>
              <Link href={'https://twitter.com/'} target="_blank">
                <i className="icon-twitter text-gray-900"></i>
              </Link>
              <Link href={'https://pinterest.com/'} target="_blank">
                <i className="icon-pinterest text-gray-900"></i>
              </Link>
            </div>
          </div>
        </div>
