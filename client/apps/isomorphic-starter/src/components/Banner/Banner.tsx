      ...
      <div className="banner-block style-one grid sm:grid-cols-2 gap-5 md:pt-20 pt-10">
        ...
        >
          ...
          <div className="banner-content absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
            {" "}
            <div className="heading2 text-gray-50">Best Sellers</div>{" "}
            <div className="text-button text-gray-50 relative inline-block pb-1 border-b-2 border-white duration-500 mt-2">
              Shop Now
            </div>{" "}
          </div>{" "}
        </Link>{" "}
        ...
        >
          ...
          <div className="banner-content absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
            {" "}
            <div className="heading2 text-gray-50">New Arrivals</div>{" "}
            <div className="text-button text-gray-50 relative inline-block pb-1 border-b-2 border-white duration-500 mt-2">
              Shop Now
            </div>{" "}
          </div>{" "}
