      ...
      <div className="container">
        ...
        <div className="heading flex items-center justify-between gap-5 flex-wrap w-full">
          ...
          <div className="menu-tab flex items-center bg-surface rounded-2xl gap-2 p-1">
            {" "}
            {["watch", "ipad", "phone", "headphone", "keyboard&mouse"].map(
              (type) => (
                <div
                  key={type}
                  className={`tab-item relative text-secondary text-button-uppercase py-2 px-5 cursor-pointer duration-500 hover:text-gray-900 ${activeTab === type ? "active" : ""}`}
