export const routes = {
  ...
  eCommerce: {
    ...
    editPurchase: (id: string) => `/ecommerce/purchases/${id}/edit`,
    purchaseVendors: '/ecommerce/purchases/vendors',
    ...
    purchaseAgreementDetails: (id: string) =>
      `/ecommerce/purchases/agreements/${id}`,
    // Vendor Pricelists
    vendorPricelists: '/ecommerce/purchases/pricelists',
    createVendorPricelist: '/ecommerce/purchases/pricelists/create',
    vendorPricelistDetails: (id: string) =>
      `/ecommerce/purchases/pricelists/${id}`,
    // UOM Conversions
