...
const navItems: NavItem[] = [
  { label: 'Warehouses', href: routes.warehouses.list },
  {
    label: 'Inventory',
    items: [
      { label: 'Products', href: routes.eCommerce.subProducts },
      { label: 'Categories', href: routes.eCommerce.categories },
      { label: 'Brands', href: routes.eCommerce.brands },
    ],
  },
  {
    label: 'Purchases',
    items: [
      { label: 'Purchase Orders', href: routes.eCommerce.purchases },
      { label: 'Receive Stock', href: routes.eCommerce.receivePurchase },
  ...
  { label: 'Point of Sale', href: routes.pos.index },
];
